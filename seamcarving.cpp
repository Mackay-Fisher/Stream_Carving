...
int main() { 
  ...
  {
    cout<<"Error: target width must be less than file width, "<<targetWidth<<" is greater than "<<width<<endl;
    return 0;
  }
  cin >> targetHeight;
  if (cin.fail())
  ...
  {
    cout<<"Error: target width must be less than file height, "<<targetHeight<<" is greater than "<<height<<endl;
    return 0;
  }
